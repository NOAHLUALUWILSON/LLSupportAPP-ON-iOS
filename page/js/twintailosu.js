    ...
    if (tail == 0){
      ...
      if (c.skilleffect == 11){
        if (c.triggertype == 1)
          ...
          if (newv == 0)
            ...
            skill = parseInt(70000*score*possibility/100/require)
        }
        else if (c.triggertype == 6)
      ...
      if (c.skilleffect == 9){
        if (c.triggertype == 1)
          ...
          skill = parseInt(1000*score*possibility/100/require*(500-(require-1)/2)/500)/1000
        else if (c.triggertype == 4)
          skill = parseInt(1000*score*possibility/100/require*(500-(require-1)/2)/500)/1000
        else if (c.triggertype == 6)
          skill = parseInt(1000*0.95*score*possibility/100/require*(475-(require-0.95)/2)/475)/1000
      }
      //score
      if (c.skilleffect == 11){
        if (c.triggertype == 1)
          ...
          skill = parseInt(80/1.1/1.17/1.02/0.994*score*possibility/100/require*(500-(require-1)/2)/500)
        else if (c.triggertype == 4)
          skill = parseInt(80/1.1/1.17/1.02/0.994*score*possibility/100/require*(500-(require-1)/2)/500)
        else if (c.triggertype == 5){
          if (newv == 0)
            ...
            skill = parseInt(70000*score*possibility/100/require*(600000-require/2)/600000)
        }
        else if (c.triggertype == 6)
          skill = parseInt(80/1.1/1.17/1.02/0.994*score*0.95*possibility/100/require*(475-(require-0.95)/2)/475)
        else if (c.triggertype == 12)
          skill = parseInt(80/1.1/1.17/1.02/0.994*score*65/500*0.95*possibility/100/require*(65-(require-1)/2)/65)
        if ((c.triggertype != 5) && (newv == 1))
          skill = parseInt(skill/1.1)
      }
    }
