...
/*
   ...
   function strengthlevel(s){
    if (s >= 7478)
      return 'SS+'
   	//7361±ß½ç£º×îÇ¿¾õÐÑ·ÖUR£º³õÆÚÏ£
   	if (s >= 7243)
   		return 'SS'
   	//7243±ß½ç£º×îÈõ¾õÐÑ·ÖUR£º³øÄïmaki
   	if (s >= 6898)
   		return 'S+'
   	//6856±ß½ç£º×îÇ¿¾õÐÑ·Ç·ÖUR£º»úÌünico
   	else if (s >= 6642)
   		return 'S'
   	//6534±ß½ç£º×îÇ¿Î´¾õÐÑ·ÖUR£º³õÆÚÏ£
   	else if (s >= 6416)
   		return 'A+'
   	//6416±ß½ç£º×îÈõÎ´¾õÐÑ·ÖUR£º³øÄïmaki
   	else if (s >= 6062)
   		return 'A'
   	//6020±ß½ç£º×îÇ¿Î´¾õÐÑ·Ç·ÖUR£º»úÌünico
   	else if (s >= 5830)
   		return 'A-'
   	//5830±ß½ç£º×îÈõÎ´¾õÐÑ·Ç·ÖUR£º³õÆÚÄñ
   	else if (s >= 5753)
   		return 'B+'
   	//5752 
   	else if (s >= 5520)
   	...
   	//5520±ß½ç
   		...
   		return 'B-'
   	//5350±ß½ç£º×îÇ¿Âú¼¶¼Ó·ÖR£ºR¹û¡¢ÃÎÃÅnico
   	else if (s >= 5180)
   		return 'C+'
   	//5180±ß½ç
   	else if (s >= 5000)
   	...
   	//5000±ß½ç
   		...
   		return 'C-'
   	//4750±ß½ç£º×îÈõÎ´¾õÐÑSR£º³õÆÚÏ£¡¢ÉÍÔÂÁÝ
   	else if (s >= 4500)
   		return 'D+'
   	//4500±ß½ç
   	else
